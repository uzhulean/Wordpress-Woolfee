...
<ul class="nav nav-tabs" id="awt-widget">
	<li><a href="#awaken-popular" role="tab" data-toggle="tab"><?php _e( 'Plus Vus', 'awaken' ); ?></a></li>
	<li><a href="#awaken-comments" role="tab" data-toggle="tab"><?php _e( 'Comz', 'awaken' ); ?></a></li>
	<li><a href="#awaken-tags" role="tab" data-toggle="tab"><?php _e( 'Mots-Clés', 'awaken' ); ?></a></li>
</ul>
	...
	<div class="tab-pane fade" id="awaken-tags">
		<?php        
			...
			if($tags) {               
				...
				_e( 'Pas de mots-clés trouvés, bouh. :(', 'awaken');           
			}            
		?>
