...
function acx_fsmi_purchased_licence_add_callback()
{
	...
	if($acx_fsmi_purchased_licence != "")
	{
		if (strpos($acx_fsmi_purchased_licence, 'FSMI') !== false) 
		{
			...
			else
			{
				...
				{
					echo __("Sorry, Your license validation failed due to ".$response['response_status'].", Please contact support","floating-social-media-icon");
				}
			}
		}
		else
	...
	{
		echo __("Licence Code is Empty","floating-social-media-icon");
	} 
	die();
}
